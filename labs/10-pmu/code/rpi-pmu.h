...
#define pmu_stmt_measure(msg, type0, type1, stmts) do {     \
    uint32_t _c0 __attribute__((unused));                    \
    uint32_t _c1 __attribute__((unused));                    \
    pmu_stmt_measure_set(_c0,_c1,msg, type0, type1, stmts);   \
} while(0)
...
// OMFG.  these weren't inlined!!  major mistake.
