// engler: timing checks for the ws2812b code.  
//  - after you finish part 0, this should be a formality --- we keep it
//    as an end-to-end check.
//
// requires that you implement:
//       - delay_ncycles
//       - t1h, t1l, t0h, t0l 
//
// what to do:
...
#define align()  asm volatile (".align 5")
