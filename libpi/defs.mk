...
ifndef CS240LX_2026_PATH
$(error CS240LX_2026_PATH is not set: this should contain the absolute path to where this directory is.  Define it in your shell's initialiation.  For example, .tcshrc for tcsh or .bashrc for bash)
endif
...
OD  = $(ARM)-objdump
OCP = $(ARM)-objcopy
CS240LX_2026_LIBPI_PATH = $(CS240LX_2026_PATH)/libpi
LPP = $(CS240LX_2026_LIBPI_PATH)
LPI ?= $(LPP)/libpi.a
LGCC ?= $(CS240LX_2026_PATH)/lib/libgcc.a
